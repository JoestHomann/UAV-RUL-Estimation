...
| `feature_redundancy.py` | Which channels contain overlapping information? | Row/UAV Pearson and Spearman matrices, clustered heatmap, strong pairs and clusters |
