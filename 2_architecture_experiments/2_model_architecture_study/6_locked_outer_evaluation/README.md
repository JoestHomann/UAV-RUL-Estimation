...
After Step 5 is complete, run all locked evaluations from the repository root:
    ...
    py 2_architecture_experiments\2_model_architecture_study\6_locked_outer_evaluation\run_locked_outer_evaluation.py

Individual completed-plan studies can be run separately:

    py 2_architecture_experiments\2_model_architecture_study\6_locked_outer_evaluation\run_locked_outer_evaluation.py --family xgboost --outer-fold 0
