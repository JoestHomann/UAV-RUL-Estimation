...
Run from the repository root:
    ...
    py 2_architecture_experiments\2_model_architecture_study\2_tabular_data_adapter\build_tabular_data_adapter.py
...
copy checker. The checker can also be run independently:
    ...
    py 2_architecture_experiments\2_model_architecture_study\2_tabular_data_adapter\verify_copied_files.py
