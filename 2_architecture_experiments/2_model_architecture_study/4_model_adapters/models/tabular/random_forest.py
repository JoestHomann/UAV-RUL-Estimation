"""Implement the sample-weighted Random Forest architecture."""
...
class RandomForestAdapter(ModelAdapter):
    ...
    def fit(self, training_data: Any, validation_data: Any | None) -> TrainingSummary:
        """Fit independently seeded trees to unchanged engineered features."""
        ...
        self.estimator = RandomForestRegressor(
            ...
            # The experiment runner controls model-level work. One estimator
            # worker avoids hidden nested parallelism between candidates.
            n_jobs=1,
        )
