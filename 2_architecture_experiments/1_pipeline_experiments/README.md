...
`2_architecture_experiments/1_pipeline_experiments/runs/PE_run_2/PE_signal_family_ablation/reporting/`. Positive
...
`2_architecture_experiments/1_pipeline_experiments/runs/PE_run_3/workflow/`.
...
below `2_architecture_experiments/1_pipeline_experiments/runs/PE_run_3/PE3_final_ensemble/`. It does not
...
`2_architecture_experiments/1_pipeline_experiments/runs/PE_run_3/figures/`. Sub-experiments retain only their
...
`2_architecture_experiments/1_pipeline_experiments/runs/PE_run_4/artifacts/`; the four plots are gathered in
`2_architecture_experiments/1_pipeline_experiments/runs/PE_run_4/figures/`. Kaggle confirmation is pending.
...
`2_architecture_experiments/1_pipeline_experiments/runs/<pipeline_run>/phase2/`. Steps 5-7 use the same
...
`2_architecture_experiments/1_pipeline_experiments/runs/<pipeline_run>/` and is kept
