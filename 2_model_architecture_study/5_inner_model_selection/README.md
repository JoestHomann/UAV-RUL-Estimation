...
Run the entire inner-selection stage from the repository root:
    ...
    py 2_model_architecture_study\5_inner_model_selection\run_inner_model_selection.py
...
be run separately while writing to the same artifact directory:
    ...
    py 2_model_architecture_study\5_inner_model_selection\run_inner_model_selection.py --family xgboost --outer-fold 1
